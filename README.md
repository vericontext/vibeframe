...
**The video CLI for AI agents.** YAML pipelines. 13 AI providers. 61 MCP tools bundled.
...
The CLI is the primary interface; MCP is the gateway for Claude Desktop & Cursor users (61 MCP tools exposed). No clone needed — add to your config and restart:
