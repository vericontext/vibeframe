      ...
      <section className="pt-32 pb-20 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12 animate-fade-in-up delay-100">
            16-second promo · 5 scenes · each backdrop generated fresh by gpt-image-2 · Kokoro narrates · Whisper word-syncs the captions · scene durations auto-extend to fit each narration so nothing gets cut.
