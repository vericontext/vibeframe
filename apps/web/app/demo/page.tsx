      ...
      <section className="pt-32 pb-20 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12 animate-fade-in-up delay-100">
            19-second promo · 5 scenes · gpt-image-2 generates each backdrop · Kokoro narrates · Whisper word-syncs the captions · 0.4 s crossfade joins · scene durations auto-extend to fit each narration.
