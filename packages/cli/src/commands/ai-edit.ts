...
// noise-reduce + fade moved to _shared/edit/{noise-reduce,fade}.ts (v0.69 Phase 3)
export { executeNoiseReduce } from "./_shared/edit/noise-reduce.js";
export type { NoiseReduceOptions, NoiseReduceResult } from "./_shared/edit/noise-reduce.js";
...
// video review types moved to _shared/edit/video-review.ts (v0.69 Phase 3)
export type {
  AutoFix,
  VideoReviewCategory,
  VideoReviewFeedback,
