/**
 * ai-edit.ts — Video/audio editing commands (FFmpeg + AI + Whisper).
 *
...
import { getVideoDuration, getAudioDuration } from '../utils/audio.js';
...
/**
 * Register all edit sub-commands on the given parent command.
 */
