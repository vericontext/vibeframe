...
- remove the eight legacy commands, 101 -> 93 (#300)

### Documentation

- state the Hyperframes boundary before teaching any command (#301)
...
- lead with the generation layer instead of the zero-key path (#281)

### Fixed

- report where the Hyperframes rules actually live (#280)
...
- add Evolink LLM provider

### Documentation

- refresh showcase media with character-consistent render
...
- reject internal phase clips and warn on over-long beats *(scene)*
...
- upgrade actions to Node 24 runtime
- opt into Node 24 action runtime
...
- update video-status schema snapshot for Veo
...
- stop text shimmer in screenshot-captured renders *(cli)*

## [0.104.2] - 2026-05-03

### Fixed

- generate/* honor vibe setup --scope project keys from nested directories *(cli)*

## [0.104.1] - 2026-05-03

### Fixed

- seed CLI bin placeholder before pnpm install + soften libass warning *(install)*
...
- asset metadata sidecars + product-surface filtering + storyboard draft hardening *(cli)*

## [0.101.0] - 2026-05-02

### Added

- cache-aware build planning + asset reference cues + review report fixOwners *(cli)*
...
- disambiguate motion-graphics routing — generate motion vs edit text-overlay *(cli)*

## [0.95.1] - 2026-05-01

### Fixed

- scope DESIGN.md hard-gate to BUILD flow + verb-less paste defaults to ASSET *(cli)*
...
- simplify isProviderChoiceConfigured — drop unused extra-keys lookup *(cli)*

## [0.94.0] - 2026-05-01

### Added

- drop FAL_KEY back-compat alias — FAL_API_KEY is the only canonical name *(providers)*

## [0.93.0] - 2026-05-01

### Added

- canonical FAL_API_KEY env name + envAliases back-compat mechanism *(providers)*
...
- setup wizard — Esc/← keyboard shortcut for Back *(cli)*

## [0.91.8] - 2026-05-01

### Fixed

- setup wizard — Back navigation in features and providers steps *(cli)*

## [0.91.7] - 2026-05-01

### Fixed

- setup wizard — sticky pre-selection of already-configured providers *(cli)*

## [0.91.6] - 2026-05-01

### Fixed

- envelope snapshots — make CLI invocation hermetic so CI matches dev *(cli)*

## [0.91.5] - 2026-05-01

### Fixed

- tests — invoke built CLI instead of tsx, ~50% faster suite *(cli)*

## [0.91.4] - 2026-05-01

### Fixed

- setup wizard — chunked-input safety, post-section continue loop, no pre-checked provider *(cli)*

## [0.91.3] - 2026-05-01

### Fixed

- setup wizard multi-select — pick-focused must redraw + clearer hint *(cli)*

## [0.91.2] - 2026-05-01

### Fixed

- setup wizard header — make scope explicit with path + intent line *(cli)*

## [0.91.1] - 2026-05-01

### Fixed

- setup wizard — per-feature provider picker with Enter-selects-default *(cli)*

## [0.91.0] - 2026-05-01

### Added

- split fal/seedance — fal.ai is the gateway, Seedance is the model *(providers)*

## [0.90.0] - 2026-05-01

### Added

- config scope (user / project) — opt into per-project config.yaml *(cli)*

### Documentation

- 1.0 readiness audit + drift fixes

## [0.89.0] - 2026-04-30

### Added

- shell completion (zsh / bash / fish) generated from program tree *(cli)*

## [0.88.0] - 2026-04-30

### Added

- catalog clarity — label doctor counts, hide power-user, tag 24 free, dynamic footer *(cli)*

## [0.87.0] - 2026-04-30

### Added

- cost UX wrap-up — run dry-run rollup, arrow agent confirm, schema filter *(cli)*

## [0.86.0] - 2026-04-30

### Added

- cost-tier UX polish — REPL spend, doctor mix, build estimate *(cli)*
...
- live key verification + first-run demo nudge *(cli)*

### Maintenance

- auto-create GitHub Release on tag push *(ci)*
...
- browser-open hotkey + arrow Confirm + dual walkthrough surfacing *(cli)*
...
- auto-generated CLI reference + agent context overhaul (v0.79.3)

## [0.79.2] - 2026-04-29

### Documentation

- fix `-s` short flag in DEMO.md generate image example

## [0.79.1] - 2026-04-29

### Fixed

- v0.79.1 patch — doctor ffmpeg fix message + validation parity *(cli)*

## [0.79.0] - 2026-04-29

### Fixed

- v0.79 patch — broken help examples, stale walkthroughs, structured errors *(cli)*

## [0.78.0] - 2026-04-29

### Added

- v0.78 polish — critical bug fixes + short flag dedup *(cli)*

## [0.77.0] - 2026-04-29

### Added

- v0.77 polish — verb-first leaves + timeline symmetry *(cli)*
